...
$packageArgs = @{
    packageName    = 'oci-cli'
    fileType       = 'msi'
    url64bit       = 'https://github.com/oracle/oci-cli/releases/download/v3.90.3/oci-cli-3.90.3-Windows-Server-Installer.msi'
    checksum64     = 'e6fb7971ca81f354b1bf7f1f37a294fc737ea2449dc60c8fb70a643c27aac2ab'
