...
$packageArgs = @{
    packageName    = 'oci-cli'
    fileType       = 'msi'
    url64bit       = 'https://github.com/oracle/oci-cli/releases/download/v3.89.3/oci-cli-3.89.3-Windows-Server-Installer.msi'
    checksum64     = '1981b3bb62fcfac7448f9241fb0185a62847f229a6b8a508e4b4197e1b9e4ec6'
