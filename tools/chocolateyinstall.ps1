...
$packageArgs = @{
    packageName    = 'oci-cli'
    fileType       = 'msi'
    url64bit       = 'https://github.com/oracle/oci-cli/releases/download/v3.90.1/oci-cli-3.90.1-Windows-Server-Installer.msi'
    checksum64     = '81f685566eed34e3090d4437d2668ce323114afe2068bdf21040779b3435c094'
