...
$packageArgs = @{
    packageName    = 'oci-cli'
    fileType       = 'msi'
    url64bit       = 'https://github.com/oracle/oci-cli/releases/download/v3.90.0/oci-cli-3.90.0-Windows-Server-Installer.msi'
    checksum64     = '20786b67e0a8ce1faf8e01a7363fa9013fd9da9b0178951ceae98d494de6ab5c'
